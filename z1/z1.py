...
# :%s/log("15\d*/\="log(\"".line(".")/
# Fallos:
## Si no hay farosOtros casco en buscafaro
## Si tengo triangulable pero están en triángulo -> no triangulo

### Buscafaro:
## Si consigo todos los faros casca.
## Si estoy al lado de un faro de otra persona y me gana en energía pierdo muchas salidas/entradas al faro
## Si estoy en medio de la nada y todos los faros tienen más energía que yo, debería recolectar
...
## Hacer conexiones
## Recargas
## Si se los puntos que me da y me quita cada faro sabre mejor que hacer (futuro)
